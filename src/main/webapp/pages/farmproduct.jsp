...
<head>
    ...
    <title>FarmSmartIndia  Products</title>
...
<div class="container-fluid py-5">
    <div class="container">
        <div class="mx-auto text-center mb-5" style="max-width: 500px;">
            <h6 class="text-primary text-uppercase"><h1>Buy Products</h1></h6>
            <br>
            <h2>Contact our specialists, and get delivery at your doorsteps-</h2> <br>
            
            <h4>Fertilizers- 1800 111 111</h4> <br>
            <h4>Crops- 1800 222 222</h4> <br>
            <h4>Insecticides and Pesticides- 1800 333 333</h4> <br>
        </div>
        <div class="row">
