 ...
 <div class="container-fluid bg-footer bg-primary text-white mt-5">
    ...
    <div class="container-fluid bg-dark text-white py-4">
        <div class="container text-center">
            <p class="mb-0">&copy; <a class="text-secondary fw-bold" href="#">FarmSmartIndia.Com</a>. All Rights Reserved.  <a class="text-secondary fw-bold" href="https://www.linkedin.com/in/gauravpatil13/">A1 girls</a></p>
        </div>
    </div>
    <!-- Footer End -->
