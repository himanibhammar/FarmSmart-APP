...
<title>FarmSmartIndia Homepage</title>
                ...
                <a href="product">
                    <div class="service-item bg-light text-center p-5" style="border-radius: 32px;">
                       <i class="fa-solid fa-cart-shopping display-1 text-primary mb-3"></i>
                        <h4>Get at Doorsteps</h4>
                        <p class="mb-0">Need any products at your doorsteps? Don't worry , we have got your back ! Connect with our specialists to get the purest of all products at your footsteps!</p>
                    </div>
                     </a>
                </div>
                <div class="col-lg-4 col-md-6" >
